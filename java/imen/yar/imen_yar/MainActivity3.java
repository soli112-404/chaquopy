...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Activity elements
        TextView text = findViewById(R.id.textii);
        ...
        DrawerLayout.LayoutParams params_text = (DrawerLayout.LayoutParams) text.getLayoutParams();
                        ...
                        if(!(address.equals(""))){
                            ...
                            if(address_char.length > 5){
                                ...
                                if(local_address.equals("http:")){
                                    ...
                                    params_text.setMargins(215, 500,215,1198);
                                            ...
                                            try{
                                                ...
                                                if (interpreterOutput != null) {
                                                    if(interpreterOutput.equals("F\n")){
                                                        ...
                                                        params_text.setMargins(290, 500,290,1198);
                                                        text.setLayoutParams(params_text);
                                                        System.out.println(code);
                                                        i += 1;
                                                        check_button.setText("Re-start");
